...
import com.mari05lim.tandera.model.util.IntUtils;
...
import static com.mari05lim.tandera.model.Constants.TWO_LETTER_CODE;
import static com.mari05lim.tandera.model.util.TimeUtils.isPastStartingPoint;
        ...
        if (!MoviesCollections.isEmpty(releases.countries)) {
            ...
            for (CountryRelease release : releases.countries) {
                if (countryCode != null && countryCode.equalsIgnoreCase(release.iso_3166_1)) {
                    ...
                    break;
                } else if (TWO_LETTER_CODE.equalsIgnoreCase(release.iso_3166_1)) {
                    usRelease = release;
                }
            }
