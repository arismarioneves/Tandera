 ...
 * DEV Mari05liM
 */
public class TanderaImageView extends androidx.appcompat.widget.AppCompatImageView {

    private static final String LOG_TAG = TanderaImageView.class.getSimpleName();
    ...
    public interface OnLoadedListener {
        ...
        void onSuccess(TanderaImageView imageView, Bitmap bitmap, String imageUrl);

        void onError(TanderaImageView imageView);
    }

    public TanderaImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onDetachedFromWindow() {
        Picasso.get().cancelRequest(mBitmapTarget);
    ...
    private final Target mBitmapTarget = new Target() {
        ...
        public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
            ...
            if (mImageHandler != null) {
                if (mImageHandler.mListener != null) {
                    mImageHandler.mListener.onSuccess(TanderaImageView.this, bitmap, mImageHandler.getImageUrl(TanderaImageView.this));
                }
        ...
        public void onBitmapFailed(Exception e, Drawable errorDrawable) {
            if (mImageHandler != null) {
                if (mImageHandler.mListener != null) {
                    mImageHandler.mListener.onError(TanderaImageView.this);
                }
                mImageHandler.markAsFinished();
            }
        }
