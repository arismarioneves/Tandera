...
import com.mari05lim.tandera.mvp.presenters.SearchPresenter;
import com.mari05lim.tandera.mvp.views.SearchView;
import com.mari05lim.tandera.mvp.views.UiView;
import com.mari05lim.tandera.util.ImeUtils;
...
import com.mari05lim.tandera.views.fragments.base.BaseDetailFragment;
...
public class SearchFragment extends BaseDetailFragment<ApplicationState.SearchResult> implements SearchView {
    ...
    private MovieAdapter TanderaAdapter;
    private PeopleAdapter mPeopleAdapter;
    private TvShowAdapter mShowsAdapter;

    private final View.OnClickListener onCancelClicked = v -> cancelSearch();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        this.mSearchEdit.setOnEditorActionListener((v, actionId, event) -> {
        ...
        this.mSearchEdit.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                //showKeyboard
        ...
        this.mSearchViewContainer.post(() -> {
    ...
    public UiView.TanderaQueryType getQueryType() {
        return UiView.TanderaQueryType.SEARCH;
    }
    ...
    private class MovieAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            imageView.loadPoster(item, new TanderaImageView.OnLoadedListener() {
                @Override
            ...
            view.setOnClickListener(v -> showMovieDetail(item, imageView));
    ...
    private class PeopleAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            imageView.loadProfile(item, new TanderaImageView.OnLoadedListener() {
                @Override
                public void onSuccess(TanderaImageView imageView, Bitmap bitmap, String imageUrl) {
                    mImageUrl = imageUrl;
                }
            ...
            view.setTag(mImageUrl);
            view.setOnClickListener(v -> showPersonDetail(item, imageView));
    ...
    private class TvShowAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            view.setTag(item);
            view.setOnClickListener(v -> showTvShowDetail(item, imageView));
    ...
    public MovieAdapter getMoviesAdapter() {
        if(TanderaAdapter == null) {
            TanderaAdapter = new MovieAdapter(LayoutInflater.from(getActivity()));
        }
        return TanderaAdapter;
    }
