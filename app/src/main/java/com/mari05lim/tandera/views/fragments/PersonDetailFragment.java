...
import com.mari05lim.tandera.mvp.presenters.PersonPresenter;
...
public class PersonDetailFragment extends BaseAnimationFragment<PersonWrapper> implements PersonView {
    ...
    @Override
    public void showPersonCreditsDialog(TanderaQueryType queryType) {
        ...
        switch (queryType) {
            case PERSON_CREDITS_CAST:
                ...
                mTitle = getResources().getString(R.string.person_cast_movies);
                break;
            case PERSON_CREDITS_CREW:
                list.setAdapter(getCrewCreditAdapter());
                mTitle = getResources().getString(R.string.person_crew_movies);
                break;
        }
    ...
    public TanderaQueryType getQueryType() {
        return TanderaQueryType.PERSON_DETAIL;
    }
    ...
    private DetailAdapter populateUi() {
        ...
        if (mPosterImageView != null) {
            mPosterImageView.loadProfile(mPerson, new TanderaImageView.OnLoadedListener() {
                @Override
    ...
    public class PersonHeaderBinder extends BaseViewHolder<PersonHeaderBinder.ViewHolder> {
        ...
        class ViewHolder extends UltimateRecyclerviewViewHolder {
            ...
            TanderaImageView personImage;

            public ViewHolder(View view) {
                super(view);
                personImage = view.findViewById(R.id.poster_image);
                }
        }
    }
    ...
    public class PersonTitleBinder extends BaseViewHolder<PersonTitleBinder.ViewHolder> {
        ...
        class ViewHolder extends UltimateRecyclerviewViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                subtitle1 = view.findViewById(R.id.textview_subtitle_1);
                subtitle2 = view.findViewById(R.id.textview_subtitle_2);
            }
        }
    }
    ...
    public class PersonBiographyBinder extends BaseViewHolder<PersonBiographyBinder.ViewHolder> {
        ...
        class ViewHolder extends UltimateRecyclerviewViewHolder {
            ...
            public ViewHolder(View view) {
                super(view);
                biography = view.findViewById(R.id.textview_biography);
            }
        }
    }
    ...
    public class PersonCastBinder extends BaseViewHolder<PersonCastBinder.ViewHolder> {
        ...
        public void bindViewHolder(ViewHolder holder, int position) {
            ...
            cardLayout.setTitle(R.string.person_cast_movies);

            final View.OnClickListener seeMoreClickListener = v -> showPersonCreditsDialog(TanderaQueryType.PERSON_CREDITS_CAST);
    ...
    public class PersonCrewBinder extends BaseViewHolder<PersonCrewBinder.ViewHolder> {
        ...
        public void bindViewHolder(ViewHolder holder, int position) {
            ...
            cardLayout.setTitle(R.string.person_crew_movies);

            final View.OnClickListener seeMoreClickListener = v -> showPersonCreditsDialog(TanderaQueryType.PERSON_CREDITS_CREW);
    ...
    private abstract class BaseCreditAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
           ...
           // Preconditions.checkState(credit.getTitle() == null, "credit.getTitle() != null  " + credit.getTitle());
            ...
            TextView subTitle = view.findViewById(R.id.textview_subtitle_1);
...
//                    }
                //TODO CrewCreditAdapter, Busca na Web too
            });
        }
